import { hasInjectionContext, getCurrentInstance, toRef, isRef, inject, version, ref, readonly, mergeProps, defineComponent, watchEffect, watch, onMounted, nextTick, openBlock, createElementBlock, renderSlot, createTextVNode, toDisplayString, createElementVNode, resolveComponent, resolveDirective, withDirectives, normalizeClass, createBlock, createCommentVNode, toRaw, unref, normalizeStyle, resolveDynamicComponent, withCtx, Fragment, toHandlers, withModifiers, TransitionGroup, renderList, createVNode, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isShallow, isReactive, computed, h, Suspense, Transition } from 'vue';
...
async function applyPlugin(nuxtApp, plugin2) {
  ...
  if (typeof plugin2 === "function") {
    const { provide: provide5 } = await nuxtApp.runWithContext(() => plugin2(nuxtApp)) || {};
    if (provide5 && typeof provide5 === "object") {
      for (const key in provide5) {
        nuxtApp.provide(key, provide5[key]);
      }
    }
  }
}
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-a50fef04.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.name) ?? "admin-product-productmain",
    path: (__nuxt_page_meta$7 == null ? void 0 : __nuxt_page_meta$7.path) ?? "/admin/product/productmain",
    ...
    component: () => import('./_nuxt/index-7e3f477a.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.name) ?? "admin-system-config",
    path: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.path) ?? "/admin/system/config",
    meta: __nuxt_page_meta$6 || {},
    alias: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.alias) || [],
    redirect: (__nuxt_page_meta$6 == null ? void 0 : __nuxt_page_meta$6.redirect) || void 0,
    component: () => import('./_nuxt/index-60501949.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.name) ?? "admin-system-module",
    path: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.path) ?? "/admin/system/module",
    meta: __nuxt_page_meta$5 || {},
    alias: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.alias) || [],
    redirect: (__nuxt_page_meta$5 == null ? void 0 : __nuxt_page_meta$5.redirect) || void 0,
    component: () => import('./_nuxt/index-189b1b86.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.name) ?? "admin-system-organization",
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/admin/system/organization",
    meta: __nuxt_page_meta$4 || {},
    alias: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.alias) || [],
    redirect: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.redirect) || void 0,
    component: () => import('./_nuxt/index-1b3f6c3e.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "admin-system-tag",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/admin/system/tag",
    meta: __nuxt_page_meta$3 || {},
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/index-af6e7d98.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.name) ?? "admin-system-user",
    path: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.path) ?? "/admin/system/user",
    meta: __nuxt_page_meta$2 || {},
    alias: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.alias) || [],
    redirect: (__nuxt_page_meta$2 == null ? void 0 : __nuxt_page_meta$2.redirect) || void 0,
    component: () => import('./_nuxt/index-0dc8fb8b.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "danh-muc-tag",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/danh-muc/:tag()",
    meta: __nuxt_page_meta$1 || {},
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/_tag_-f182c215.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-44d7e02f.mjs').then((m) => m.default || m)
  },
  {
    name: "users",
    path: "/users",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3ea8b605.mjs').then((m) => m.default || m)
  }
];
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }, { "name": "description", "content": "Giày nam: website bán giày da bò cao cấp cho nam đã có mặt trên thị trường từ những năm 2009. Toàn bộ sản phẩm giày tại shop đều được làm bằng da bò có chế bộ bảo hành hẫu mại đến khi hỏng" }, { "name": "keywords", "content": "Giày nam 2023 giá rẻ, Giầy nam 2023, Giày lười nam, Giày mọi nam, Giày tăng chiều cao nam, Giày cao cổ nam, Giày nam đẹp - Giaynam.com - website bán giày nam chất lượng hàng đầu việt nam" }], "link": [{ "rel": "stylesheet", "href": "./assets/base.css" }, { "rel": "icon", "type": "image/x-icon", "href": "./favicon.ico" }], "style": [], "script": [], "noscript": [], "title": "Những mẫu giày nam đẹp nhất" };
...
function resolveUnrefHeadInput(ref2, lastKey = "") {
  ...
  if (Array.isArray(root4))
    return root4.map((r) => resolveUnrefHeadInput(r, lastKey));
  if (typeof root4 === "object") {
    return Object.fromEntries(
      Object.entries(root4).map(([k, v]) => {
  ...
  setAttributes: function setAttributes(element) {
    ...
    if (element) {
          ...
          if (v !== null && v !== void 0) {
            ...
            if (type === "string" || type === "number") {
              ...
              var _cv = Array.isArray(v) ? computedStyles2(rule, v) : Object.entries(v).map(function(_ref3) {
                var _ref4 = _slicedToArray$2(_ref3, 2), _k = _ref4[0], _v = _ref4[1];
      ...
      Object.entries(attributes).forEach(function(_ref5) {
        var _ref6 = _slicedToArray$2(_ref5, 2), key = _ref6[0], value = _ref6[1];
...
var script$6 = {
  ...
  methods: {
    ...
    _getPTValue: function _getPTValue() {
      ...
      var merged = mergeProps(self, globalPT2, _objectSpread$1(_objectSpread$1({}, key === "root" && _defineProperty$2({}, "".concat(datasetPrefix, "name"), ObjectUtils.toFlatCase(this.$.type.name))), {}, _defineProperty$2({}, "".concat(datasetPrefix, "section"), ObjectUtils.toFlatCase(key))));
      return merged;
    },
    ptm: function ptm() {
    ...
    sx: function sx() {
      ...
      var params = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      if (when) {
        var self = this._getOptionValue(this.$css.inlineStyles, key, _objectSpread$1({
          instance: this,
          props: this.$props,
          state: this.$data,
          parentInstance: this.$parentInstance
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _hoisted_3$1, 8, _hoisted_1$3), createElementVNode("defs", null, [createElementVNode("clipPath", {
...
var BaseDirective = {
  ...
  _getPTValue: function _getPTValue2() {
    ...
    var merged = mergeProps(self, globalPT2, _objectSpread(_objectSpread({}, key === "root" && _defineProperty$1({}, "".concat(datasetPrefix, "name"), ObjectUtils.toFlatCase(instance.$name))), {}, _defineProperty$1({}, "".concat(datasetPrefix, "section"), ObjectUtils.toFlatCase(key))));
    return merged;
  },
...
var _hoisted_1$2 = ["aria-label", "disabled", "data-pc-severity"];
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16, _hoisted_1$2)), [[_directive_ripple]]);
}
...
var isNonEmptyString = (value) => isString2(value) && value.trim().length > 0;
...
var isVueComponent = (c) => isFunction2(c) || isObject2(c);
var isToastContent = (obj) => !isUndefined(obj) && (isString2(obj) || isVueComponent(obj) || isToastComponent(obj));
var isDOMRect = (obj) => isObject2(obj) && ["height", "width", "right", "left", "top", "bottom"].every((p) => isNumber(obj[p]));
var hasProp = (obj, propKey) => (isObject2(obj) || isFunction2(obj)) && propKey in obj;
function getX(event) {
...
var normalizeToastComponent = (obj) => {
  ...
  const props = hasProp(obj, "props") && isObject2(obj.props) ? obj.props : {};
  const listeners = hasProp(obj, "listeners") && isObject2(obj.listeners) ? obj.listeners : {};
...
var EventBus = class {
  ...
  on(eventType, handler3) {
    const handlers = this.getHandlers(eventType);
    handlers.push(handler3);
    this.allHandlers[eventType] = handlers;
  }
  off(eventType, handler3) {
    const handlers = this.getHandlers(eventType);
    handlers.splice(handlers.indexOf(handler3) >>> 0, 1);
  }
  emit(eventType, event) {
    const handlers = this.getHandlers(eventType);
    handlers.forEach((handler3) => handler3(event));
  }
};
var TYPE;
(function(TYPE2) {
...
var VtCloseButton_default = defineComponent({
  ...
  computed: {
    ...
    classes() {
      ...
      return classes2.concat(this.classNames);
    }
  }
});
...
var VtIcon_default = defineComponent({
  ...
  computed: {
    ...
    iconClasses() {
      const classes2 = [`${VT_NAMESPACE}__icon`];
      if (this.hasCustomIcon) {
        return classes2.concat(this.customIconClass);
      }
      return classes2;
    }
  },
...
var VtToast_default = defineComponent({
  ...
  computed: {
    ...
    bodyClasses() {
      const classes2 = [
        `${VT_NAMESPACE}__toast-${isString2(this.content) ? "body" : "component-body"}`
...
var VtToastContainer_default = defineComponent({
  ...
  methods: {
    ...
    getClasses(position) {
      const classes2 = [`${VT_NAMESPACE}__container`, position];
      return classes2.concat(this.defaults.containerClassName);
    }
  }
});
...
var Tooltip = BaseTooltip.extend("tooltip", {
  ...
  unmounted: function unmounted3(el, options) {
    var target = this.getTarget(el);
    this.remove(target);
    this.unbindEvents(target, options);
  ...
  methods: {
    ...
    create: function create2(el, options) {
...
const primevue_TdXjRgL1MA = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp.vueApp.use(VueSweetalert2, options);
  nuxtApp.vueApp.use(VueCryptojs);
  nuxtApp.vueApp.use(PrimeVue, { ripple: true });
  nuxtApp.vueApp.component("Button", script$2);
  nuxtApp.vueApp.component("InputText", script);
...
const layouts = {
  adminlayout: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/adminlayout-aed7e1b4.mjs').then((m) => m.default || m)),
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-b184f054.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-680772a1.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-524fa150.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-76a34d89.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { BaseDirective as B, ConnectedOverlayScrollHandler as C, DomHandler as D, FilterService as F, ObjectUtils as O, Ripple as R, UniqueComponentId as U, ZIndexUtils as Z, _export_sfc as _, useRoute as a, useRouter as b, createError as c, useState as d, entry$1 as default, useRuntimeConfig as e, useStyle as f, script$4 as g, script$3 as h, FilterMatchMode as i, FilterOperator as j, script$2 as k, useToast as l, useNuxtApp as m, navigateTo as n, script as o, primebus as p, script$5 as q, script$6 as s, useHead as u };
