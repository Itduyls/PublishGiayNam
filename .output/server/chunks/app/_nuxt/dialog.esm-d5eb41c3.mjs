...
import { f as useStyle, Z as ZIndexUtils, D as DomHandler, U as UniqueComponentId, R as Ripple, s as script$6, g as script$4$1 } from '../server.mjs';
import { computed, openBlock, createElementBlock, mergeProps, createElementVNode, resolveComponent, resolveDirective, createBlock, withCtx, createVNode, Transition, withDirectives, renderSlot, toDisplayString, createCommentVNode, resolveDynamicComponent, createTextVNode } from 'vue';
import { F as FocusTrap, b as script$l } from './paginator.esm-79cc5f95.mjs';
import { s as script$1$2 } from './index.esm-c4d8e664.mjs';

const _imports_0 = "" + buildAssetsURL("nodata.5884fd54.png");
...
var _hoisted_1$3 = ["id", "checked", "disabled", "aria-checked", "aria-labelledby", "aria-label"];
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread$1(_objectSpread$1({}, _ctx.inputProps), _ctx.ptm("hiddenInput"))), null, 16, _hoisted_1$3)], 16), createElementVNode("span", mergeProps({
...
export { _imports_0 as _, script as a, script$4 as s };
//# sourceMappingURL=dialog.esm-d5eb41c3.mjs.map
